...
emcc -g $(find ta-lib-source/src/ta_func/*.c) ta-lib-source/src/ta_common/ta_global.c  -Ita-lib-source/include/ -Ita-lib-source/src/ta_common/ -s SINGLE_FILE=1 -s LINKABLE=1 -s EXPORT_ALL=1 -s WASM=1 -s "EXTRA_EXPORTED_RUNTIME_METHODS=['ccall', 'cwrap']" -O0 -fno-inline -o build/talib.html -o build/talib.js
